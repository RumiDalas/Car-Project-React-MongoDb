        ...
        <div className="carousel w-full h-[600px]">
            <div id="slide1" className="carousel-item relative w-full">
                ...
                <div className="absolute rounded-xl flex items-center h-full w-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21,21,0)] ">
                    ...
                    <h2 className='text-6xl font-bold'>Affrodable Price for car servicing</h2>
                    <p>There are many variation of passages available, but the majority have suffered</p>
                    <div>
